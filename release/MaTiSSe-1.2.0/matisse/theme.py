...
__css__ = """/* CSS theme generated by MaTiSSe.py */
*, *:after, *:before {
...
class Theme(object):
  ...
  def __init__(self, source=None, name='theme', div_id='', default=True):
    """
    Parameters
    ----------
    source: str
    ...
    if source is not None:
      self.get(source=source, name=name, div_id=div_id, default=default)
    return
  ...
  def get(self, source, name='theme', div_id='', default=True):
    """
