...
class Theme(object):
  ...
  def set_from(self, other):
    ...
    """
    _attrs = [
      'canvas', 'toc', 'toc_chapter_emph', 'toc_section_emph',
      'toc_subsection_emph', 'toc_slide_emph', 'slide', 'slide_content',
      'slide_header', 'slide_footer', 'slide_sidebar',
      'box', 'box_caption', 'box_content',
      ...
      'slide_header_metadata', 'slide_footer_metadata', 'slide_sidebar_metadata',
      'css', 'custom',
    ]
    for attr in _attrs:
