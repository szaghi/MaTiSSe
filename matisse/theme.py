    ...
    def copy_from(self, other):
        ...
        for header in other.slide_header_metadata:
            if header not in self.slide_header_metadata:
                ...
                append_css(
                    my_element=self.slide_header_metadata[header], other_element=other.slide_header_metadata[header]
                )
        for footer in other.slide_footer_metadata:
            if footer not in self.slide_footer_metadata:
                ...
                append_css(
                    my_element=self.slide_footer_metadata[footer], other_element=other.slide_footer_metadata[footer]
                )
        for sidebar in other.slide_sidebar_metadata:
            if sidebar not in self.slide_sidebar_metadata:
                ...
                append_css(
                    my_element=self.slide_sidebar_metadata[sidebar], other_element=other.slide_sidebar_metadata[sidebar]
                )
        self.__check_slide()
        self.__get_css()
