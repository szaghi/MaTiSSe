...
def main():
  ...
  cliparser.add_argument('--offline', required=False, action='store_true', default=False, help='Use local bundled copies of impress.js, MathJax and highlight.js instead of CDN (useful for air-gapped environments)')
